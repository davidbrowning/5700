...
{
    [TestClass]
    public class PreOrderIteratorTester
    {
        [TestMethod]
        public void PreOrderIterator_TestOnAtomicExpression()
        {
            Constant exp = new Constant() { Value = 1.2 };

            Iterator i = exp.GetPreOrderIterator();
            Assert.IsNotNull(i);
        ...
        [TestMethod]
        public void PreOrderIterator_TestUnaryExpression()
        {
        ...
        [TestMethod]
        public void PreOrderIterator_TestBinaryExpression()
        {
            Variable v1 = new Variable() { Label = "A" };
        ...
        [TestMethod]
        public void PreOrderIterator_TestFunctionExpression()
        {
            Variable v1 = new Variable() { Label = "A" };
            Variable v2 = new Variable() { Label = "B" };
        ...
        [TestMethod]
        public void PreOrderIterator_TestExpressionTree()
        {
            Variable v1 = new Variable() { Label = "A" };
            Variable v2 = new Variable() { Label = "B" };
            ...
            Iterator i = exp4.GetPreOrderIterator();
            Assert.IsNotNull(i);
            Assert.IsNull(i.Current);
            Assert.IsFalse(i.IsDone);
