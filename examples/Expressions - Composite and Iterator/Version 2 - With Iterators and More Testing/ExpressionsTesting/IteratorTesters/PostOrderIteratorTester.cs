...
{
    [TestClass]
    public class PostOrderIteratorTester
    {
        [TestMethod]
        public void PostOrderIterator_TestOnAtomicExpression()
        {
            Constant exp = new Constant() { Value = 1.2 };

            Iterator i = exp.GetPostOrderIterator();
            Assert.IsNotNull(i);
        ...
        [TestMethod]
        public void PostOrderIterator_TestUnaryExpression()
        {
        ...
        [TestMethod]
        public void PostOrderIterator_TestBinaryExpression()
        {
            Variable v1 = new Variable() { Label = "A" };
        ...
        [TestMethod]
        public void PostOrderIterator_TestFunctionExpression()
        {
            Variable v1 = new Variable() { Label = "A" };
            Variable v2 = new Variable() { Label = "B" };
        ...
        [TestMethod]
        public void PostOrderIterator_TestExpressionTree()
        {
            Variable v1 = new Variable() { Label = "A" };
            Variable v2 = new Variable() { Label = "B" };
            ...
            Iterator i = exp4.GetPostOrderIterator();
            Assert.IsNotNull(i);
            Assert.IsNull(i.Current);
            Assert.IsFalse(i.IsDone);
