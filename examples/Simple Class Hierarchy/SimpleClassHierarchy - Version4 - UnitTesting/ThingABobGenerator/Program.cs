...
namespace TestDataGenerator
{
    public class Program
    {
        ...
        {
            collection.Add(new Gadget() { Id = 50, Name = "A", Length = 3, Width = 4 });
            collection.Add(new Widget() { Id = 51, Name = "B", Weight = 20.5 });
            collection.Add(new Gadget() { Id = 52, Name = "C", Length = 4, Width = 4 });
            ...
            collection.Add(new Gadget() { Id = 56, Name = "G", Length = 20, Width = 4 });
            collection.Add(new Gadget() { Id = 57, Name = "H", Length = 12, Width = 5 });
        }
