...
{
    public class ColorChangingDecorator : BallDecorator
    {
        ...
        public override void Start()
        {
            ...
            _normalColor = DecoratedBall.Color;
        ...
        private void ChangeColor(object sender)
        {
            ...
            {
                DecoratedBall.Color = NextColor(DecoratedBall.Color, AltColor);
                if (ColorAreEquivilent(DecoratedBall.Color, AltColor))
                    _changeType = ChangeDirection.ToNormal;
            }
            else
            {
                DecoratedBall.Color = NextColor(DecoratedBall.Color, _normalColor);
                if (ColorAreEquivilent(DecoratedBall.Color, _normalColor))
